var guest2 = ["Sabah", "Fatimah", "Alishba"];
...
for (var i = 0; i <= 2; i++) {
    ...
    console.log("".concat(guest2[i], ", you are invited to party"));
...
console.log("\n".concat(guest2[1], " Ap mat ana jaga nhy hai!\n"));
...
for (var a = 0; a < guest2.length; a++) {
    ...
    console.log("".concat(guest2[a], " Ap logo ko Party mai ana hai!"));
