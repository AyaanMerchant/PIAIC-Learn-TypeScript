var guest3 = ["Sabah", "Fatimah", "Alishba"];
...
for (var i = 0; i <= 2; i++) {
    ...
    console.log("".concat(guest3[i], ", you are invited to party"));
...
console.log("\n".concat(guest3[1], " Ap mat ana jaga nhy hai!\n"));
...
for (var a = 0; a < guest3.length; a++) {
    ...
    console.log("".concat(guest3[a], " Ap logo ko Party mai ana hai!"));
...
console.log("Final List is ".concat(guest3));
