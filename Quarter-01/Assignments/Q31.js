...
var userName2 = ["Ayaan", "Fatimah", "Hussain", "Iqbal", "Areesh", "Admin", "Ali", "Ahmed"];
...
// If the userName2 array is not empty
    ...
    for (var a = 0; a < userName2.length; a++) {
        ...
        // If the current element is not "Admin"
            ...
            console.log("Hello ".concat(userName2[a], ", Thank You For Logging In Again"));
        }
    }
}
